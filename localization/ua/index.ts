export default {
  ...
  app: {
    ...
    noInternetModal: {
      ...
      description:
        "Будь ласка, перевірте своє інтернет-з'єднання і спробуйте ще раз. Додаток буде закритий.",
    },
    menu: {
      mode: "Режим",
      run: "Побігли",
    ...
    settings: {
      ...
      accountLinkage: {
        ...
        error: {
          title: "Помилка",
          description:
            "Не вдалося прив'язати обліковий запис. Будь ласка, спробуйте ще раз. Повідомлення про помилку: ",
        },
      },
      theme: {
        dark: "Темна",
    ...
    playlists: {
      ...
      delete: "Видалити",
      noPlaylistsToActivate: "Немає плейлистів для активації",
      noPlaylistsToImport: "Немає плейлистів для імпорту",
